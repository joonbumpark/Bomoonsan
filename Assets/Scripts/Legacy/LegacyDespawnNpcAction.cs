...
namespace Mountains
{
    // LegacySpawnNpcAction/SpawnPathWalkerNpcAction이 만든 NPC를 다시 치우는 액션. 대상 액션을
    ...
    [AddComponentMenu("")]
    public class LegacyDespawnNpcAction : LegacyNpcTargetingAction
    {
        public enum Mode
        {
            Destroy,
        ...
        static void RestoreNavMeshAgent(GameObject npc)
        {
            ...
            {
                Debug.LogWarning($"[LegacyDespawnNpcAction] {npc.name}: NavMesh 위로 되돌리지 못했습니다. " +
