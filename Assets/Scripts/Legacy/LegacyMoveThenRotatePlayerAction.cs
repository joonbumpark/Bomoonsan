...
namespace Mountains
{
    ...
    [AddComponentMenu("")]
    public class LegacyMoveThenRotatePlayerAction : LegacyTriggerAction
    {
        ...
        public override void Execute(Action onComplete)
        {
            ...
            {
                Debug.LogWarning("[LegacyMoveThenRotatePlayerAction] player 또는 destination이 없어 이동을 건너뜁니다.");
                onComplete?.Invoke();
                return;
            }
